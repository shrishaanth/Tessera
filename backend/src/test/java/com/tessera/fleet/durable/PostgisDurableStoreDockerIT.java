...
class PostgisDurableStoreDockerIT {
    ...
    @Test
    void siteVisitFactsAndReportingWindowComeBackFromRealSql() {
        long base = 1_700_100_000_000L;
        store.saveGeofenceEvents(List.of(
                GeofenceEventRecord.enter("V1", "S1", base + 100_000L),
        ...
        assertThat(store.reportingWindow().siteExits()).isGreaterThanOrEqualTo(2);
    }
}
